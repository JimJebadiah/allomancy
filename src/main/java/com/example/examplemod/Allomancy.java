...
public class Allomancy {
    ...
    public static final RegistryObject<Item> STEEL_MIND = ITEMS.register("steel_mind", () -> new SteelMind(new Item.Properties().stacksTo(1)));
    public static final RegistryObject<Item> PEWTER_MIND = ITEMS.register("pewter_mind", () -> new PewterMind(new Item.Properties().stacksTo(1)));
    ...
    public Allomancy() {
        ...
        MetalMinds.register(modEventBus);
